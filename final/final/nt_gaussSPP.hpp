//
//  Filename:     gaussSPP.hpp
//  Programmer:   Nicholas Trampe
//  Class:        CS 5201 - Clayton Price
//  Assignment:   4 - A Parameterized Matrix Class and Gaussian Elimination
//
//  Description:  Here are the definitions of the functions declared in the gaussSPP class
//
//


template <class T>
bool gaussSPP<T>::operator()(vector<T>& aX, const matrix<T>& aA, const vector<T>& aB)
{
	// augmented matrix
	matrix<T> augMat(aA);
